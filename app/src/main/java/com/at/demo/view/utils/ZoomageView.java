package com.at.demo.view.utils;
...
/**
 * ZoomageView is a pinch-to-zoom extension of {@link }, providing a smooth
...
public class ZoomageView extends AppCompatImageView implements ScaleGestureDetector.OnScaleGestureListener {
     ...
     *
     * @return the current width of the image as displayed (not the width of the {@link } itself.
     */
     ...
     *
     * @return the current height of the image as displayed (not the height of the {@link } itself.
     */
     ...
     * it to the outer bounds of the {@link }. If the current
